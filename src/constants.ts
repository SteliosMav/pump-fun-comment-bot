...
export const BOT_DESCRIPTION = `🎁FREE token-pass for new users! 🌐Combine words: "ez" AND "pump" AND ".fun" | Telegram: "ez_" AND "pump_" AND "bot". The most reliable, cheap and easy to use!`;
